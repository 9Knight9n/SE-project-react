...
class VillaProfile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      owner_image: "",
      fixed_rules: [
        "You can get 100% refund by 72 hours before reservation start date.",
        "You can get 50% refund by 24 hours before reservation start date.",
        "You can get 20% refund if you cancel your resercation less than 24 hours to start date.",
      ],
      host_rules: ["No Smoke", "No Pets", "No Extra People"],
      location: [0, 0],
      isReserved: null,
      place_address: null,
