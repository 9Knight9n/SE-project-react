...
class MessageBox extends React.Component {
  state = {
    ...
    isPhoto:
      String(this.props.data).match(/\.(jpeg|jpg|gif|png)$/) !== null &&
      ...
      <React.Fragment>
        ...
        >
          <div
            className="w-100"
            onClick={() => {
              if (this.state.isFile) window.open(this.state.data, "_blank");
            }}
          >
            <MB
              id={this.state.id}
                ...
                <div className={"d-flex flex-column"}>
                  ...
                  {this.state.isFile ? (
                    <div style={{ maxWidth: "250px", color: "black" }}>
                      <EllipsisToolTip>
                        {
                          String(this.state.data).split("/")[
                            String(this.state.data).split("/").length - 1
                          ]
                        }
                      </EllipsisToolTip>
                    </div>
