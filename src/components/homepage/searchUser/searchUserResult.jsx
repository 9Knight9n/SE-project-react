...
class SearchUserResult extends Component {
  ...
  render() {
    return (
      <div
        className={"container p-2 border-primary m-1  rounded"}
        style={{ border: "2px solid", width: "inherit" }}
      >
          ...
          <div className={"ml-auto"}>
            {parseInt(getItem("user-id")) === this.props.userid ? (
              ...
              <button
                ...
                className={"ml-auto btn transparent-button shadow-none"}
              >
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="bi bi-chat-text mt-2"
                  viewBox="0 0 16 16"
                >
