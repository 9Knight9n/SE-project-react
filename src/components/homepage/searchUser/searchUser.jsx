          ...
          <div style={{ width: "inherit", position: "relative" }}>
            ...
            >
              <input
                ...
                className=" form-control shadow-none search-user"
                placeholder="Search"
                id="search-input-field-chat"
              />
            </div>
            <div
              id="panel"
              className={"mt-2 w-100".concat(
                this.state.panelOpened ? " active" : ""
              )}
            >
              <div
                id="search-sub-panel1"
                className={"ml-3 mr-3 mt-3".concat(
                ...
                {this.state.panelOpened && this.state.suggestions
                  ? this.state.suggestions.map((sug) => (
                      <SearchUserResult
                        ...
                        email={sug.email}
                        profile={sug.image}
                        last_name={sug.last_name}
                        isFriend={sug.isFriend}
                        first_name={sug.first_name}
                      />
                    ))
                  : ""}
              </div>
          ...
          >
            {this.state.focused ? (
              <svg
                ...
                height="27px"
                fill="currentColor"
                className="bi bi-x align-self-center"
                viewBox="0 0 16 16"
              >
