    ...
    return (
      ...
      <React.Fragment>
        ...
        >
          ...
          >
            <VillaCarousel
              url={API_SEARCH_VILLA}
              addNum={true}
              cardSize={parseInt(this.state.cardsSize)}
              title={"New places:"}
            />
            <VillaCarousel
              url={API_TOP_RATED_VILLA}
              addNum={true}
              cardSize={parseInt(this.state.cardsSize)}
              title={"High rate places:"}
            />
            <VillaCarousel
              url={API_MOST_REGISTERED_VILLA}
              addNum={true}
              cardSize={parseInt(this.state.cardsSize)}
              title={"Most reserved places:"}
            />

            {getItem("user-id") ? (
              <VillaCarousel
                url={API_FAVORITE_VILLA}
                cardSize={parseInt(this.state.cardsSize)}
